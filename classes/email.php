<?php
// Source
// https://medium.com/@AnthonyBudd/wp-mail-send-templated-emails-with-wordpress-314a71f83db2
...
class Email {
     ...
     * @return String
     */
    public static function html_filter() {
	return 'text/html';
    }
	...
	$this->before_send();
	return wp_mail($this->to, $this->subject, $this->render(), $this->build_headers(), $this->attachments);
    }
}
